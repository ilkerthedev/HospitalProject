...
public class Branches {
    ...
    public void fillBranchList() {
        ...
        Branches branch6 = new Branches(105, "Nefroloji");
        Branches branch7 = new Branches(106, "Üroloji");
        Branches branch8 = new Branches(107, "Dermatoloji");
        Branches branch9 = new Branches(108, "Cocuk Sagligi");
        Branches branch10 = new Branches(109, "Kadin Hastaliklari");
        Branches branch11 = new Branches(110, "Gastroenteroloji");
        Branches branch12 = new Branches(111, "Göz Hastaliklari");
        Branches branch13 = new Branches(112, "Radyoloji");
        Branches branch14 = new Branches(113, "Agiz,Cene ve Dis Sagligi");
        Branches branch15 = new Branches(114, "Beslenme ve Diyet");
        Branches branch16 = new Branches(115, "Dahiliye");
        Branches branch17 = new Branches(116, "Endoskopi");
        Branches branch18 = new Branches(117, "Psikoloji");
        Branches branch19 = new Branches(118, "Estetik Cerrahi");
        Branches branch20 = new Branches(119, "Gögüs Hastaliklari");
